...
<body>
                            ...
                            <ul class="mobile-menu-nav">
                             <li><a data-toggle="collapse" data-target="#democrou" href="#Interface"></a>
                                    <ul id="democrou" class="collapse dropdown-header-top">
                                        <li><a href="index.php">Todas las Ubicaciones</a></li>
                                    </ul>
                                </li>
                                  <!--  
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li class="active"><a data-toggle="tab" href="#Interface"><i class="notika-icon notika-house"></i>Ubicacion</a>
                        </li>
                    ...
                    <div class="tab-content custom-menu-content">
                        <div id="Interface" class="tab-pane active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="index.php">Todas las Ubicaciones</a>
                                </li>
                            </ul>
                        </div>
                        <div id="Home" class="tab-pane in notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="index.php">Google Map</a>
                                </li>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Google Maps</h2>
                                        <p>Celulas del CFA Central<span class="bread-ntd"></span></p>
                                    </div>
                                </div>
                            </div>
    ...
    <style type="text/css">
        ...
        <?php 
            ...
            $edu = new education;
            $coll = $edu->getMapscelulaBlankLatLng();
            $coll = json_encode($coll, true);
            echo '<div id="data">' . $coll . '</div>';

            $allData = $edu->getAllMapscelula();
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="footer-copy-right">
                        <p>
                            <a href="https://github.com/luksmustang/Ubicaciones-Maps">GitHub-luksmustang</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=(Usar su api aqui)callback=loadMap">
    </script>
    <!-- main JS
        ============================================ -->
